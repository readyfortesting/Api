...
public class GetRequest17 extends GMIBankBaseUrl {
    ...
    */
    ...
    public void test17(){
        ...
        Map<String, Object> actualData = response.as(HashMap.class); //HashMap ile De-Serialization YAPTIK
        ...
        Map<String, Object> actualData2 = response.as(Map.class); // Map ile De-Serialization YAPTIK
